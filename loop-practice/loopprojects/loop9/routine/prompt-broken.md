# Routine prompt — RECENT-COMMIT SUMMARY (BROKEN version)

This is the DELIBERATELY BROKEN copy of `prompt.md`. It is identical except
that Step 1 points at an input file that does not exist.
...
1. Read the input file
   `loop-practice/loopprojects/loop9/routine/inputs/recent-commits-do-not-exist.md`.
